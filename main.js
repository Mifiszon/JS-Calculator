...
const calcualtorHistory = document.querySelector('.history');
...
function addToHistory () {
    ...
    calcualtorHistory.appendChild(newHistoryItem)
}
...
function clearHistory () {
    calcualtorHistory.textContent = '';
    if(calcualtorHistory.textContent === ''){
